...
export default class Search {
  ...
  // 3. Methods
  // Method for typing in the search input field
  keyPressHandler() {
  ...
  renderResultsHTML(posts) {
    if (posts.length) {
      ...
      this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">No results found for that search.</p>`;
    }
    this.hideLoaderIcon();
    this.showResultsArea();
  }

  // Method for the search loader once a user start typing
  showLoaderIcon() {
